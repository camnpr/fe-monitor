...
let ApiUrl = 'http://localhost:52791/apiback/';
...
export const api = {
    ...
    // 广告模块
    "adAdd": ApiUrl + "adverts/adds.ashx", // 添加
    "adUpdate": ApiUrl + "adverts/updates.ashx", // 修改
    "adList": ApiUrl + "adverts/lists.ashx", // 列表
    "adUpload": ApiUrl + "adverts/uploads.ashx", //上传图片

    "queryStudentsItem": ApiUrl + "queryStudentsItem", //学生单条详情
}
