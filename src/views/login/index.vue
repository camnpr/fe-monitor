<template>
    <div class="login-container">
        <el-form autoComplete="on" :model="loginForm" :rules="loginRules" ref="loginForm" label-position="left"
            ...
            <h3 class="title"><i class="fa fa-user-circle-o" aria-hidden="true"></i>系统登录</h3>
            ...
            <div class='tips'>测试帐号为:camnpr@163.com 密码：123456</div>
                ...
                if (valid) {
                  this.loading = true;
                    var  par = JSON.parse(JSON.stringify(this.loginForm)) ;
                         par.password = md5('@gome'+par.password);
